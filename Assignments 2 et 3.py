# -*- coding: utf-8 -*-
"""
Created on Thu Jan 16 10:45:30 2020

@author: ameliepingeot
"""
...
train = pd.read_csv('/Users/ameliepingeot/Documents/ESCP Europe/Cours/Machine Learning with Python/Assignment pour le 22 mars/train.csv')
test = pd.read_csv('/Users/ameliepingeot/Documents/ESCP Europe/Cours/Machine Learning with Python/Assignment pour le 22 mars/test1.csv')
...
final_table.to_csv('Assignments2and3.csv', index=False)
